...
<template>
    <div class="flex flex-shrink-0">
        <span :class="['flex flex-shrink-0 items-center px-2.5 py-0.5 rounded-full text-xs font-medium', statusElement.backgroundColor, statusElement.textColor]">
        <svg :class="['-ml-0.5 mr-1.5 h-2 w-2', statusElement.circleColor]" fill="currentColor" viewBox="0 0 8 8">

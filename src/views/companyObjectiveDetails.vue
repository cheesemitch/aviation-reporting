<script>
import objectivesData from '/src/companyObjectives.json'
...
import SecondaryButton from '../components/TheSecondaryButton.vue'
import PrimaryButton from '../components/ThePrimaryButton.vue'
import {
  TransitionRoot,
  TransitionChild,
  Dialog,
  ...
  <div class="max-w-5xl mx-auto">
          ...
          <ol role="list" class="flex items-center space-x-4">
            <li>
              <div class="flex items-center mr-2">
                <router-link :to="{name: 'company.objectives'}" class="group flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 dark:text-gray-400/80 dark:hover:text-gray-200">
                  <svg class="h-5 w-5 flex-shrink-0 text-gray-400 group-hover:text-gray-700 mr-2 dark:text-gray-400/80 dark:group-hover:text-gray-200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
          ...
          <div class="flex flex-1">
            ...
            <div class="w-full">
              <div class="flex items-start justify-between">
                <h2 class="mt-5 text-2xl font-semibold leading-7 text-gray-900 dark:text-gray-200 sm:tracking-tight">{{objective.name}}</h2>
              ...
              <h3 class="mt-1 text-sm font-medium text-gray-500/80 dark:text-gray-400/80">
                {{objective.description}}
              </h3>
              <div class="mt-1.5 hidden flex-col sm:mt-1 sm:flex-row sm:flex-wrap justify-between">
                <div class="flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap">
                  <div class="mt-1.5 flex items-center text-sm font-medium text-gray-500/80 mr-6 dark:text-gray-400/80">
                ...
                <div class="flex">
                  <div class="mt-1.5 flex items-center text-sm font-medium text-gray-500/80 dark:text-gray-400/80">
                    <svg class="mr-1.5 h-4 w-4 flex-shrink-0 text-gray-400 dark:text-gray-400/80" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                      <path fill-rule="evenodd" d="M5.75 2a.75.75 0 01.75.75V4h7V2.75a.75.75 0 011.5 0V4h.25A2.75 2.75 0 0118 6.75v8.5A2.75 2.75 0 0115.25 18H4.75A2.75 2.75 0 012 15.25v-8.5A2.75 2.75 0 014.75 4H5V2.75A.75.75 0 015.75 2zm-1 5.5c-.69 0-1.25.56-1.25 1.25v6.5c0 .69.56 1.25 1.25 1.25h10.5c.69 0 1.25-.56 1.25-1.25v-6.5c0-.69-.56-1.25-1.25-1.25H4.75z" clip-rule="evenodd" />
                    </svg>
    ...
    <section class="mt-8">
      ...
      <div class="sm:flex sm:items-end sm:justify-between">
        <div class="">
          <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-200">Objective Details</h2>
          <div class="flex flex-col sm:flex-row mt-2 sm:mt-1 space-y-2 sm:space-y-0 sm:space-x-6">
            <div class="flex items-center">
              <svg class="mr-1.5 h-4 w-4 flex-shrink-0 text-gray-400 dark:text-gray-400/80" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                <path fill-rule="evenodd" d="M5.75 2a.75.75 0 01.75.75V4h7V2.75a.75.75 0 011.5 0V4h.25A2.75 2.75 0 0118 6.75v8.5A2.75 2.75 0 0115.25 18H4.75A2.75 2.75 0 012 15.25v-8.5A2.75 2.75 0 014.75 4H5V2.75A.75.75 0 015.75 2zm-1 5.5c-.69 0-1.25.56-1.25 1.25v6.5c0 .69.56 1.25 1.25 1.25h10.5c.69 0 1.25-.56 1.25-1.25v-6.5c0-.69-.56-1.25-1.25-1.25H4.75z" clip-rule="evenodd" />
              </svg>
              <p class="text-sm text-gray-500 dark:text-gray-400/80">          
      ...
      <div class="mt-6">
        ...
        <div class="grid grid-cols-1 gap-5 sm:grid-cols-3">
          <!-- imtem -->
          <div class="rounded-xl p-8 bg-white dark:bg-gray-800">
            <span :class="['rounded-lg inline-flex p-3 bg-'+objective.secondaryColor+' dark:bg-cyan-900 text-'+objective.textColor+' dark:text-cyan-300 ring-4 ring-white dark:ring-gray-800']">
            ...
            <h3 class="mt-6 font-semibold text-gray-900 dark:text-gray-200">Responsible</h3>
            <div class="mt-3 relative flex items-center">
              ...
              <div class="min-w-0 flex-1 ml-3">
                <a href="#" class="focus:outline-none">
                  ...
                  <p class="text-sm font-medium text-gray-900 dark:text-gray-200">{{ responsiblePerson.name }}</p>
                  <p class="truncate text-sm text-gray-500 dark:text-gray-400/80">{{ responsiblePerson.title }}</p>
                </a>
              </div>
            </div>
          </div>
          <div class="rounded-xl p-8 bg-white dark:bg-gray-800">
            ...
            <h3 class="mt-6 font-semibold text-gray-900 dark:text-gray-200">Duration</h3>
            <div class="mt-2 flex items-center text-sm font-medium text-gray-500/80 dark:text-gray-400/80">
          ...
          <div class="rounded-xl p-8 bg-white dark:bg-gray-800">
            ...
            <h3 class="mt-6 font-semibold text-gray-900 dark:text-gray-200">Check-In</h3>
            <div class="mt-2 flex items-center text-sm font-medium text-gray-500/80 dark:text-gray-400/80">
    ...
    <section class="mt-8">
      ...
      <div class="sm:flex sm:items-end sm:justify-between">
        <div class="">
          <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-200">Contributors</h2>
          <div class="flex flex-col sm:flex-row mt-2 sm:mt-1 space-y-2 sm:space-y-0 sm:space-x-6">
            <div class="flex items-center">
              <svg class="mr-1.5 h-4 w-4 flex-shrink-0 text-gray-400 dark:text-gray-400/80" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div class="flex mt-2 flex-col-reverse sm:flex-row sm:mt-0">
          <div class="mt-2 flex xl:mt-0 sm:mr-3">
            <SecondaryButton type="button">Manage</SecondaryButton>
          </div>
          <div class="mt-2 flex xl:mt-0">
    ...
    <section class="mt-8">
      ...
      <div class="sm:flex sm:items-end sm:justify-between">
        <div class="">
          <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-200">Key Results</h2>
          <div class="flex flex-col sm:flex-row mt-2 sm:mt-1 space-y-2 sm:space-y-0 sm:space-x-6">
            <div class="flex items-center">
              <svg class="mr-1.5 h-4 w-4 flex-shrink-0 text-gray-400 dark:text-gray-400/80" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                <path d="M15.5 2A1.5 1.5 0 0014 3.5v13a1.5 1.5 0 001.5 1.5h1a1.5 1.5 0 001.5-1.5v-13A1.5 1.5 0 0016.5 2h-1zM9.5 6A1.5 1.5 0 008 7.5v9A1.5 1.5 0 009.5 18h1a1.5 1.5 0 001.5-1.5v-9A1.5 1.5 0 0010.5 6h-1zM3.5 10A1.5 1.5 0 002 11.5v5A1.5 1.5 0 003.5 18h1A1.5 1.5 0 006 16.5v-5A1.5 1.5 0 004.5 10h-1z" />
    ...
    <section class="mt-8">
      ...
      <div class="sm:flex sm:items-end sm:justify-between">
        <div class="">
          <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-200">Initiatives</h2>
          <div class="flex flex-col sm:flex-row mt-2 sm:mt-1 space-y-2 sm:space-y-0 sm:space-x-6">
            <div class="flex items-center">
              <svg class="mr-1.5 h-4 w-4 flex-shrink-0 text-gray-400 dark:text-gray-400/80" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                <path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z"></path>
      ...
      <div class="mt-6">
        ...
        <ul v-else role="list" class="grid grid-cols-1 gap-4">
          <li v-for="initiative in objective.initiatives" :key="initiative.id" class="bg-white dark:bg-gray-800 border border-transparent rounded-xl hover:border-gray-400 overflow-hidden cursor-pointer p-4 sm:p-6">
            <div @click="openInitiativeModal(initiative.id)" class="">
              <div class="flex md:items-center">
                <div :class="['h-12 w-12 mr-3 rounded-full flex justify-center items-center bg-'+objective.secondaryColor+' dark:bg-cyan-900']">
                  <svg :class="['h-6 w-6 rounded-full dark:text-cyan-300 text-'+objective.textColor]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                  </svg>
                </div>
                <div class="w-full">
                  <div class="flex items-start justify-start">
                    <p class="text-sm font-medium text-gray-900 dark:text-gray-200 sm:truncate flex-1">
                      {{ initiative.name }}
                    </p>
                    <div class="-mr-0.5 flex-shrink-0 flex">
                      <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800 dark:bg-green-400/20 dark:text-green-400">
                      <svg class="-ml-0.5 mr-1.5 h-2 w-2 text-green-400" fill="currentColor" viewBox="0 0 8 8">
                        <circle cx="4" cy="4" r="3"></circle>
                      </svg> 
                      On track
                  ...
                  <div class="mt-1 sm:flex sm:justify-between">
                    <div class="sm:flex">
                      <p class="flex items-center text-sm text-gray-500 dark:text-gray-400/80">
                        <span class="h-4 w-4 bg-green-100 dark:bg-green-900 rounded-full flex items-center justify-center mr-2" aria-hidden="true">
                        <span class="h-2 w-2 bg-green-400 dark:bg-green-500 rounded-full"></span>
                        </span>
                        In progress
                      </p>
                      <p class="flex items-center text-sm text-gray-500/80 dark:text-gray-400/80 mt-2 sm:mt-0 sm:ml-6">
                    ...
                    <div class="mt-2 flex items-center text-sm text-gray-500/80 dark:text-gray-400/80 sm:mt-0">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="mr-1.5 h-4 w-4 flex-shrink-0 text-gray-400/80">
                        <path fill-rule="evenodd" d="M5.75 2a.75.75 0 01.75.75V4h7V2.75a.75.75 0 011.5 0V4h.25A2.75 2.75 0 0118 6.75v8.5A2.75 2.75 0 0115.25 18H4.75A2.75 2.75 0 012 15.25v-8.5A2.75 2.75 0 014.75 4H5V2.75A.75.75 0 015.75 2zm-1 5.5c-.69 0-1.25.56-1.25 1.25v6.5c0 .69.56 1.25 1.25 1.25h10.5c.69 0 1.25-.56 1.25-1.25v-6.5c0-.69-.56-1.25-1.25-1.25H4.75z" clip-rule="evenodd" />
                      </svg>
                      <p>
    ...
    <section class="mt-8">
      ...
      <div class="sm:flex sm:items-end sm:justify-between">
        <div class="">
          <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-200">Recent Activities</h2>
          <div class="flex flex-col sm:flex-row mt-2 sm:mt-1 space-y-2 sm:space-y-0 sm:space-x-6">
            <div class="flex items-center">
              <svg class="mr-1.5 h-4 w-4 flex-shrink-0 text-gray-400 dark:text-gray-400/80" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">

...
export default {
  ...
  components: {
    ...
    CompanyLogo, Dialog, DialogPanel, DialogTitle, TransitionChild, TransitionRoot,
    PrimaryButton
  }
}
    ...
    <div class="max-w-5xl mx-auto">
      ...
      <div class="max-w-3xl mx-auto md:flex md:items-center md:justify-between md:space-x-5 lg:max-w-8xl">
        <div class="flex items-start space-x-5">
          ...
          <div>
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-gray-200">Unternehmensleitbild</h1>
            <p class="text-sm font-medium text-gray-500 dark:text-gray-400/80">
              Das Unternehmensleitbild beschreibt den Kern der Unternehmensstrategie, bestehend aus Mission, Vision und Grundwerten des Unternehmens.</p>
          </div>
        </div>
      </div>
      <!-- Mission Section -->
        ...
        <div class="overflow-hidden bg-white dark:bg-gray-800 sm:rounded-lg">
          <div class="border-b border-gray-200 dark:border-gray-700 px-4 py-5 sm:px-6">
            <div class="-ml-4 -mt-4 flex flex-wrap items-center justify-between sm:flex-nowrap">
              <div class="ml-4 mt-4">
                <h3 class="text-lg font-medium leading-6 text-gray-900 dark:text-gray-200">Mission</h3>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400/80">Die Mission oder das Leitbild des Unternehmens stellt ein Ziel auf der höchsten Abstraktionsebene dar und beschreibt den Kontext für alle aktuellen Ziele und Initiativen.</p>
              </div>
          ...
          <div class="px-4 py-5 sm:px-6">
            <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
              <div class="sm:col-span-2">
                <dt class="text-sm font-medium text-gray-900 dark:text-gray-200">Beschreibung der Mission</dt>
                <dd class="mt-1 text-sm text-gray-500 dark:text-gray-400/80">{{ mission }}</dd>
              </div>
              <div class="sm:col-span-2">
                <dt class="text-sm font-medium text-gray-900 dark:text-gray-200">Anhänge</dt>
                <dd v-show="missionAttachmentsEmpty == false" class="mt-1 text-sm text-gray-500 dark:text-gray-400/80">
                  <ul role="list" class="divide-y divide-gray-200 rounded-md border border-gray-200 dark:border-gray-600">
                    <li v-for="attachment in missionAttachments" :key="attachment.filename" class="flex items-center justify-between py-3 pl-3 pr-4 text-sm">
                      <div class="flex w-0 flex-1 items-center">
                        <PaperClipIcon class="h-5 w-5 flex-shrink-0 text-gray-400 dark:text-gray-400/80" aria-hidden="true" />
                        <span class="ml-2 w-0 flex-1 truncate">{{attachment.filename}}</span>
                      </div>
                      <div class="ml-4 flex-shrink-0">
                ...
                <div class="flex">
                  <Button @click="isOpenMissionModal = true" class="cursor-pointer group mt-2 flex items-center 
                    rounded-md p-1 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus-within:ring-2 focus-within:ring-cyan-500">
                    <span class="-ml-1 flex h-8 w-8 items-center justify-center rounded-full border-2 border-dashed border-gray-300 dark:border-gray-600 text-gray-400 dark:text-gray-500">
                      <svg class="h-5 w-5" x-description="Heroicon name: mini/plus" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                        <path d="M10.75 4.75a.75.75 0 00-1.5 0v4.5h-4.5a.75.75 0 000 1.5h4.5v4.5a.75.75 0 001.5 0v-4.5h4.5a.75.75 0 000-1.5h-4.5v-4.5z"></path>
                      </svg>
                    </span>
                    <span class="ml-2.5 text-sm font-medium text-cyan-500 group-hover:text-cyan-600 dark:group-hover:text-cyan-300">Bearbeiten</span>
                    <span class="ml-1.5 text-sm font-medium text-gray-400 dark:text-gray-500 group-hover:text-gray-400 dark:group-hover:text-gray-400/80">um Anhang hinzuzufügen</span>
                  </Button>
                </div>
              </div>
            </dl>
      ...
      <section class="mt-10">
        <div class="overflow-hidden bg-white dark:bg-gray-800 sm:rounded-lg">
          <div class="border-b border-gray-200 dark:border-gray-700 px-4 py-5 sm:px-6">
            <div class="-ml-4 -mt-4 flex flex-wrap items-center justify-between sm:flex-nowrap">
              <div class="ml-4 mt-4">
                <h3 class="text-lg font-medium leading-6 text-gray-900 dark:text-gray-200">Vision</h3>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400/80">Die Vision beschreibt die Art und Weise der Zukunft eines Unternehmens aus der Sicht der Organisation.</p>
              </div>
              <div class="ml-4 mt-4 flex-shrink-0">
          ...
          <div class="px-4 py-5 sm:px-6">
            <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
              <div class="sm:col-span-2">
                <dt class="text-sm font-medium text-gray-900 dark:text-gray-200">Erklärung der Vision</dt>
                <dd class="mt-1 text-sm text-gray-500 dark:text-gray-400/80">{{ vision }}</dd>
              </div>
              <div class="sm:col-span-2">
                <dt class="text-sm font-medium text-gray-900 dark:text-gray-200">Anhänge</dt>
                <dd v-show="visionAttachmentsEmpty == false" class="mt-1 text-sm text-gray-500 dark:text-gray-400/80">
                  <ul role="list" class="divide-y divide-gray-200 rounded-md border border-gray-200 dark:border-gray-600">
      ...
      <section class="mt-10">
        <div class="overflow-hidden bg-white dark:bg-gray-800 sm:rounded-lg">
          <div class="border-b border-gray-200 dark:border-gray-700 px-4 py-5 sm:px-6">
            <div class="-ml-4 -mt-4 flex flex-wrap items-center justify-between sm:flex-nowrap">
              <div class="ml-4 mt-4">
                <h3 class="text-lg font-medium leading-6 text-gray-900 dark:text-gray-200">Grundwerte</h3>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400/80">Die Grundwerte sind die Leitprinzipien nach denen ein Unternehmen arbeitet. Sie stellen das Rückgrat einer Organisation dar.</p>
              </div>
              <div class="ml-4 mt-4 flex-shrink-0">
                <PrimaryButton @click="openCoreValuesModal()">
                  Bearbeiten 
                </PrimaryButton>  
              </div>
            </div>
          ...
          <div class="px-4 py-5 sm:px-6">
            <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
              <div class="sm:col-span-2">
                <dt class="text-sm font-medium text-gray-900 dark:text-gray-200">Beschreibung der Grundwerte</dt>
                <dd class="mt-1 text-sm text-gray-500 dark:text-gray-400/80">{{ coreValues }}</dd>
              </div>
              <div class="sm:col-span-2">
                <dt class="text-sm font-medium text-gray-900 dark:text-gray-200">Anhänge</dt>
                <dd v-show="coreValuesAttachmentsEmpty == false" class="mt-1 text-sm text-gray-500 dark:text-gray-400/80">
                  <ul role="list" class="divide-y divide-gray-200 rounded-md border border-gray-200 dark:border-gray-600">
                ...
                <div class="flex">
                  <Button @click="openCoreValuesModal()" class="cursor-pointer group mt-2 flex items-center 
                    rounded-md p-1 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus-within:ring-2 focus-within:ring-cyan-500">
                    <span class="-ml-1 flex h-8 w-8 items-center justify-center rounded-full border-2 border-dashed border-gray-300 dark:border-gray-600 text-gray-400 dark:text-gray-500">
                      <svg class="h-5 w-5" x-description="Heroicon name: mini/plus" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                        <path d="M10.75 4.75a.75.75 0 00-1.5 0v4.5h-4.5a.75.75 0 000 1.5h4.5v4.5a.75.75 0 001.5 0v-4.5h4.5a.75.75 0 000-1.5h-4.5v-4.5z"></path>
